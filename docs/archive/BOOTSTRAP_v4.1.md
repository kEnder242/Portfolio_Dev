...
**The Immutable Bootloader [v4.1]**

> [!CAUTION]
> **IMMUTABILITY PROTOCOL:** This document is a navigational primer, NOT a notepad for design details. Do NOT modify this file to track sprints, mandates, or features. All design-level "Why" context must live in **[HomeLabAI/docs/ENGINEERING_PEDIGREE.md](./HomeLabAI/docs/ENGINEERING_PEDIGREE.md)**.
...
Index of all tests and profiling tools needed to verify Silicon stability.
