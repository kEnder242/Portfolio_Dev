...
- [ ] **Task 53.14**: Scrollable Multi-Line Crosstalk Bar & System Message Routing (`intercom_v2.js` / `intercom.html`) *(Status: OPEN — Spec locked)*
